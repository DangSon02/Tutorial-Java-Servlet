            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form th:action="@{/task/add/save}" method="post" class="form-horizontal form-material">
                                    ...
                                    <div class="col-md-12">
                                        <select name="projectId" class="form-control form-control-line">
                                            <option th:each="project : ${projects}" th:value="${project.id}"
                                                th:text="${project.name}" th:selected="${project.id}==0">
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="description" placeholder="Chi tiết công việc"
                                    ...
                                    <div class="col-md-12">
                                        <select name="doerId" class="form-control form-control-line">
                                            <option th:each="user : ${users}" th:value="${user.id}"
                                                th:text="${user.name}" th:selected="${user.id}==0">
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="start-date" type="date" class="form-control form-control-line"
                                            data-date="" data-date-format="DD/MM/YYYY" name="startDate" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày Kết Thúc</label>
                                    <div class="col-md-12">
                                        <input id="end-date" type="date" class="form-control form-control-line"
                                            data-date="" data-date-format="DD/MM/YYYY" name="endDate" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
