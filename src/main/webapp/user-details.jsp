...
<head>
    ...
    <title th:text="${user.name+' | CRM Project'}">
        User | CRM Project
    </title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img class="center" width="100%" alt="user"
                                    src="/plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a>
                                            <img th:src="@{${'/plugins/images/users/'+user.image}}"
                                                class="thumb-lg img-circle" alt="img">
                                        </a>
                                        <h4 th:text="${user.name}" class="text-white">
                                            Name
                                        </h4>
                                        <h5 th:text="${user.email}" class="text-white">
                                            Email
                                        </h5>
                                    </div>
                                </div>
